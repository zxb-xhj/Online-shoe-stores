...
<div style="float: right;;;margin-top: 30px;">
	...
	<a href="${c }/sp" class="btn btn-primary" style="margin-top: 9px;"><span class="glyphicon glyphicon-shopping-cart"></span>购物车</a>
	...
	<a style="width: 200px;" class="btn btn-info" href="${c }/admin">管理员登录</a></div>
		</div>
