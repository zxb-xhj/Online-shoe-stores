...
<form action="${c }/adupdate" style="width: 250px;margin-left: 700px;margin-top: 200px;" method="post">
	<h2 style="margin-left: 40px;margin-bottom: 40px;">品牌名修改</h2>
		&ensp;&ensp;编号：<input type="text" value="${footwear[0].id }" style="background-color: #F0F0F0" name="id" readonly="readonly"><br>
		品牌名：<input type="text" style="margin-top: 10px;margin-bottom: 10px;" value="${footwear[0].name }" name="name">
		<input class="btn btn-primary" type="submit" value="提交" style="border-radius:8px;width: 80px;margin-left: 80px;">
	<a class="btn btn-primary" href="${c }/adfoot">取消</a>
	</form>
</div>
</div>
